...
const WORDS = ["Frontend Developer @Boeing", "M.tech @ IIIT Kottayam"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ssumit98" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/sumit-sabbinwar-23b87b175/" },
  { icon: Mail, link: "mailto:summit.sabbinwar@gmail.com" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                 Creating Innovative, Functional, Responsive and User-Friendly Websites...
                </p>
